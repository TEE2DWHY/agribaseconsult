      ...
      <div className={styles.productBody}>
        ...
        <div className={styles.productSecond}>
          ...
          <div className={styles.productSecond2}>
            <Sub image={check} alt="check" text="100% Quality" />
            <Sub
              image={check}
              alt="check"
              text="Fresh Eggs with no additives"
            />
            <Sub image={check} alt="check" text="Healthy Chickens" />
            <Sub image={check} alt="check" text="Hygienic Coop" />
            <Sub image={check} alt="check" text="Orders from 10 crates" />
            <p>From N4,500</p>
            <a href="https://wa.me/+2348130506443">
