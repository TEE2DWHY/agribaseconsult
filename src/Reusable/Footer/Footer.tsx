      ...
      <div className={styles.footer_head}>
        <div className={styles.footer_neck}>
          ...
          <div className={styles.footer_row3}>
            ...
            <div className={styles.footer_rowppp}>
              <Link
                to="https://maps.app.goo.gl/GMhNNjoBd5RFxfZN9"
                target="_blank"
              >
                <p>Abule Agerige village, Odeda, Abeokuta,Ogun State.</p>
              </Link>
              <Link to={"mailto:admin@agribaseconsult.farm"}>
                <p>admin@agribaseconsult.farm</p>
              </Link>
              <Link to={"tel:+23480130506443"}>
                <p>+23480130506443</p>
              </Link>
            </div>
          </div>
        ...
        <div>
          <div className={styles.footer_copyright}>
            <img src={copyright} alt="copyright" className={styles.logo} />
            <p className={styles.footer_pend}>
              {year}, Agribase. All right reserved
            </p>
          </div>
        </div>
      </div>
