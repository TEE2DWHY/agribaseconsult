        ...
        <div className={styles.secondPart1}>
          <div className={styles.secondPart01}>
            ...
            <p className={styles.productWord2}>
              Simply click on{" "}
              <span className={styles.productWord3}>BUY NOW</span> to order or
              you can reach us via our telephone number . You can also reach out
              to us from the contact page and send us a message. We assure you
              of swift delivery not later than{" "}
              <span className={styles.productWord3}>48 hours</span> from when
              order was placed
            </p>
            <a href="https://wa.me/+2348130506443" target="_blank">
